...
import {
	...
	MultipalDeleteInstructionsRequest,
} from '../../../../../redux/instructionsSlice';
const MySwal = withReactContent(Swal);

const InstructionsTable = ({ columns }) => {
	...
	const handleAllDeleteButton = (e) => {
		...
		return MySwal.fire({
			...
			if (result.value) {
				...
				await dispatch(checkedData);
				dispatch(GetAllInstrunctionsRequest(queryString));
				setCheckedData([]);
			}
		});
	};
			...
			<Card>
				<div className="app-user-list list">
					<DataTable
						...
						data={instructionsData !== null && instructionsData['findAllInstruction']}
						columns={columns}
						paginationServer
